...
description: "Activez l'API publique et réussissez votre premier appel authentifié en quelques minutes."
---
...
<Steps>
  <Step title="Activer l'API et récupérer la clé">
    Dans les **réglages de l'établissement**, activez l'API publique, puis récupérez la clé `X-Api-Key` propre à cet établissement.
