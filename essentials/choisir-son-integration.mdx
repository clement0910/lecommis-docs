...
| --- | --- | --- | --- | --- |
| **API publique** | Moyen — écrire du code de fetch et de rendu | À la demande (vous re-fetchez quand vous voulez) | Total — vous produisez votre propre HTML | Afficher des menus structurés, des horaires, l'identité avec votre design |
